...
public class EnemySelectScreen : AbstractSelectScreen
{
    ...
    public void OnCharacterCardEnter(GameObject obj)
    {
        ...
        if(obj != MainMenuScreenSwitch.Instance.DataHolder.EnemyGO)
        {
    ...
    {
        if(MainMenuScreenSwitch.Instance.DataHolder.Enemy != null)
        {
            if(MainMenuScreenSwitch.Instance.DataHolder.EnemyGO != null)
            {
                MainMenuScreenSwitch.Instance.DataHolder.EnemyGO.transform.GetChild(0).GetComponent<Image>().color = defaultColor;
            }
        }

        MainMenuScreenSwitch.Instance.DataHolder.SetEnemy(obj);
    ...
    public void UnsetEnemy()
    {
        if(MainMenuScreenSwitch.Instance.DataHolder.Enemy != null)
        {
            ...
            MainMenuScreenSwitch.Instance.DataHolder.UnSetEnemy();
        }
    }
}
