...
public class CharacterSelectScreen : AbstractSelectScreen
{
    ...
    private void SetPlayer(GameObject obj)
    {
        ...
        {
            dataHolder.PlayerGO.transform.GetChild(0).GetComponent<Image>().color = defaultColor;
        }

        dataHolder.SetPlayer(obj);
